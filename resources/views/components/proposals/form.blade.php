        ...
        <form class="flex flex-col gap-6" wire:submit="save">
            ...
            <div class="flex gap-4">
                <div class="flex flex-col w-2/3 gap-2">
                    ...
                    <input type="email" wire:model="email" class="w-full bg-[#1E1E2C] text-white p-2 focus:outline-none focus:ring-0 border border-[#1E1E2C]" placeholder="Insira o seu e-mail" />
                    @error('email')
            ...
            <div>
                <label for="agree"
                    ...
                    <div class="relative flex items-center">
                        ...
                        <x-ui.icons.check class="absolute invisible text-white -translate-x-1/2 -translate-y-1/2 pointer-events-none left-1/2 top-1/2 size-3 peer-checked:visible dark:text-white" />
                    </div>
